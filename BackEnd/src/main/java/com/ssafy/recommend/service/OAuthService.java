...
public class OAuthService{
    ...
    public String getKakaoAccessToken (String code) {
        ...
        try {
            ...
            sb.append("&client_id=e440985102cfb63167624588b53f5465"); // TODO REST_API_KEY 입력
    ...
    public KaKaoUserDto createKakaoUser(String token) {
        ...
        try {
           ...
           return KaKaoUserDto.builder().email(email).gender(gender)
                   .nickName(nickname).profileImageUrl(profile_image_url).build();
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
